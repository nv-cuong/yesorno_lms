                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="content"
                                        ...
                                        placeholder="Tên" value="{{ old('content', $question->content) }}">
                                    @error('content')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('category') is-invalid @enderror"
                                        style="width: 100%;" name="category" id="category" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="score"
                                        ...
                                        placeholder="Điểm" value="{{ old('score', $question->score) }}">
                                    @error('score')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
