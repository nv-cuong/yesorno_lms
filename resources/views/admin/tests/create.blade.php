            ...
            <div class="col-sm-12">
                ...
                <form action="{{ route('test.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('category') is-invalid @enderror category" id="id" name="category" 
                            data-dependent="question" data-placeholder="Loại bài test:">
                            <option value="">-</option>
                            <option value="0">Bài thi</option>
                        ...
                        <input type="number" class="form-control @error('time') is-invalid @enderror" 
                            value="{{ old('time') }}" id="time" placeholder="Nhập thời gian làm bài" name="time">
                        @error('time')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
