            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Thêm mới giảng viên</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group @if ($errors->has('stu_id')) has-error @endif">
                                        <label for="name" class="control-label">Mã giảng viên<span
                                    ...
                                    <div class="form-group @if ($errors->has('first_name')) has-error @endif">
                                        <label for="name" class="control-label">Tên giảng viên<span
                                                style="color: red">*</span></label>
                                ...
                                <div class="card-footer">
                                    <div class="pull-right">
                                        <button type="submit" class="btn btn-flat ladda-button btn-success btn-sm"
                                            data-style="zoom-in">
                                            <span class="ladda-label"><i class="fa fa-save"></i> Thêm mới</span>
