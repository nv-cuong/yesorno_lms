...
@section('content')
    ...
    <div class="author-info posi-rel de-padding">
        ...
        <div class="container">
            <form class="form-horizontal" method="POST" action="{{ route('profile.update', [$student->id]) }}"
                ...
                <div class=" grid-2">
                    ...
                    <div class="form-group">
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="first_name">Tên chính</label>
                            <div class="col-md-9">
                                <input class="form-control @error('first_name') is-invalid @enderror" type="text"
                                    name="first_name" id="first_name"
                                    value="{{ old('first_name') ?: $student->first_name }}" placeholder="Tên"
                                    maxlength="191">
                                @error('first_name')
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="last_name">Họ và tên đệm</label>
                            <div class="col-md-9">
                                <input class="form-control @error('last_name') is-invalid @enderror" type="text"
                                    name="last_name" id="last_name" value="{{ old('last_name') ?: $student->last_name }}"
                        ...
                        <div class="form-group row justify-content-center">
                            <div class="col-4">
                                ...
                                <a class="btn btn-danger btn-lg" href="{{ route('personal') }}">Quay lại</a>
                            </div>
                        </div>
                    </div>
                </div>
