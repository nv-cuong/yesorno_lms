            ...
            <div class="course-info-wrapper">
                <div class="course-left-sidebar">
                    <div class="course-left-box crs-post">
                        <h5 class="course-left-title">
                            Những khóa học khác
                        </h5>
                        @foreach ($courses as $courseItem)
                            <div class="course-post-wrp">
                                <img style="width : 80px; height : 80px" src="{{ asset($courseItem->image) }}"
                                    alt="thumb">
                        ...
                        <div class="course-syl-price cr-mb">
                            <ul>
                                <li>
                                    <p>
                                        <i class="fas fa-user">
                                        </i>Ngày bắt đầu: {{ $course->begin_date }}
                                    </p>
                                </li>
                                <li>
                                    <p><i class="fas fa-user">
                                        </i>Ngày kết thúc: {{ $course->begin_date }}
                                    </p>
                                </li>
                                <li>
                                    <form action="{{ route('post.detach') }}" method="get">
                                        ...
                                        <button type="submit" class="btn btn-danger" title="Đăng kí vào khóa học">
                                            Hủy
                                        </button>
                                    </form>
                                </li>
                                            ...
                                            <div class="course-over-fet">
                                                <div class="course-over-bio">
                                                    <div class="course-over-name">
                                                        <h5>
                                                            <span style="color: violet">Tên lớp: </span>
                                                            {{ $class->name }}
                                                        </h5>
                                                        <h6>
                                                            <span style="color: violet">Thời gian học: </span>
                                                            @if ($class->schedule == 0)
                                                                Sáng
